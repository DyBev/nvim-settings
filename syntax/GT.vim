...
"error highlighting
syn match GuidedTrackError '\*\(confirm\|blank\|multiple\|quit\|other\|shuffle\|yaxis\|xaxis\|yaxis\|trendline\|clear\|email\|body\|login\|navigation\|return\|everytime\|share\|events\|startup\|success\|error\|throwaway\|page\|searchable\|navigation\)\(:\)\@='
